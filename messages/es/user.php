...
return [
    ...
    'Awesome! You have successfully confirmed your email address. You may sign in using your credentials now.' => '¡Cuenta de correo confirmada! Ahora puede iniciar sesión con sus nuevos datos.',
    ...
    'We need to confirm your email address' => 'Necesitamos confirmar tu cuenta de correo electrónico',
    ...
    'You have successfully cancelled email changing process' => 'Ha cancelado el proceso de cambio de contraseña',
    ...
    'Your password has been successfully changed. You can try logging in using your new password.' => 'Su contraseña se ha modificado satisfactoriamente. Ahora puedes iniciar sesión con la nueva contraseña.',
    'Your username is {0} and your password is {1}' => 'Su nombre de usuario es: {0} y su contraseña es: {1}',
    '(not set)' => '(no establecido)',
    'A password will be generated automatically if not provided' => 'La contraseña se generará automáticamente al dejar el campo vacío',
    ...
    'Change your avatar at Gravatar.com' => 'Cambiar tu avatar en Gravatar.com',
    'Confirm' => 'Confirmar',
